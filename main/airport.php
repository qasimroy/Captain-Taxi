    ...
    <div class="p-4 d-flex justify-content-center" style="background-color: #bdbdb8;">
        <div style="padding: 0px 100px 0px 100px;">
            <ul class="booking-nav">
                <a href="booking.php" class="booking-nav-items"> Book a Car</a>
                <a href="airport.php" class="booking-nav-items booking-nav-item"> Airport Transfer</a>
            </ul>
        </div>
    </div>
    <hr>
...
<body>
    <div class='container'>
        <table style='padding: 15px 0px 15px 0px;'>
            ...
            <tr>
                <td><strong>FLIGHT NO:</strong><hr></td>
                <td>".$flightNum."</td>
            </tr>
            <tr>
            ...
            <tr>
                <td><strong>ARRIVAL TIME:</strong><hr></td>
                <td>".$arrivalTime."</td>
            </tr>
            <tr>
                <td><strong>NOTES:</strong><hr></td>
                <td>"." Dropoff Note: ".$userDropoffNote."</td>
            </tr>
        </table>
    </div>  
</body>
        ...
        // $body .= "Flight no: ".$flightNum. "\r\n";
        // $body .= "Dropoff: ".$userDropoff. "\r\n";
        // if(isset($_POST['dropoff_1']) || $_POST['dropoff_2'] || $_POST['dropoff_3'] || $_POST['dropoff_4'] || $_POST['dropoff_5'] || $_POST['dropoff_6'] != '')
        // {
        ...
        // $body .= "Dropoff Note:".$userDropoffNote. "\r\n";
...
<section class="bookCar">
    <div class=" container">
    <?php include('flatRate.php'); ?>
        <form action="airport.php" class="form-group" id="" method="POST">
            
            <h2 class="text-center">Airport Transfer</h2>
            <div class="details">
                <h3 class="text-center">Journey Details</h3>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="arrivalTime"> Arrival Time: <sup style="color: red;">*</sup></label>
                        <input type="datetime-local" class="form-control" id="arrivalTime" name="arrivalTime" required>
                    </div>
                    <div class="form-group col-md-6">
                        <label for="flightnum">Flight Number:</label>
                        <input type="text" class="form-control" placeholder="Flight Number" name="flightnum" id="flightnum">
                    </div>
                </div>
                <label for="dropoff" class="my-1">Dropoff: <sup style="color: red;">*</sup></label>
                <div class="input-group my-1">
                    <input type="text" class="form-control" placeholder="Dropoff" name="dropoff" id="dropoff" required>
                </div>
